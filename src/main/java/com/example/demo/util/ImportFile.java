...
//    @Slf4j
//    public class BatchImportSalesThread implements Runnable{
//
//        String[] titleTemplate = { "工号", "用户"};
//        private String id;
//        private File file;
...
//        private ITaskSettingService taskSettingService;
//
//        public BatchImportSalesThread(String id, File file, String fileName, String taskSettingId, String creator, String orgId) {
//            this.id = id;
//            this.file = file;
...
//            this.orgId = orgId;
//            this.taskSettingService = SpringContextUtil.getBean("taskSettingService", ITaskSettingService.class);
//        }
//
//        @Override
//        public void run() {
//            log.info("------------开始导入区域数据--------------");
//
//            List<ImportTaskSalesVO> list = null;
//            // 已处理数
//            int processNum = 1;
//            //用于处理导入结果的对象
//            ImportResultVO resultVO = new ImportResultVO();
//
//            RedisUtil.putValue(id,resultVO,30l, TimeUnit.MINUTES);
//
//            try {
//                String[] title = ExcelUtil.getExcelTitle(file,file.getName());
//                if(!ImportUtil.judgeTitleIsTrue(title,titleTemplate,resultVO)){
//                    return;
//                }
//
//                list = ExcelUtil.importForExcel(file, fileName, ImportTaskSalesVO.class);
//                //设置导入总条数
//                resultVO.setTotalNum(list.size());
//
//                List<TaskSettingUSalesVO> taskSettingSalesList = taskSettingService.querySales(Integer.parseInt(taskSettingId),"");
//                Map<String, Object> taskSettingSalesMap = new HashMap<String, Object>();
//                for (TaskSettingUSalesVO taskSettingSalesVo : taskSettingSalesList) {
//                    taskSettingSalesMap.put(taskSettingSalesVo.getWxUserId()+taskSettingSalesVo.getUsername(), "");
//                }
//
//                if(!AssertUtil.isEmpty(list)){
//                    list = ImportUtil.importExcelDataCheck(list,ImportTaskSalesVO.class);
//
//                    // 导入错误列表
//                    List errorList = resultVO.getErrorlist();
//                    if(AssertUtil.isEmpty(errorList)){
//                        errorList = new ArrayList<ImportTaskSalesVO>();
//                        resultVO.setErrorlist(errorList);
//                    }
//
//                    List<ImportTaskSalesVO> insertList = new ArrayList<ImportTaskSalesVO>();
//                    for(ImportTaskSalesVO importVo : list){
//                        resultVO.setProcessNum(processNum++);
//                        Thread.sleep(2000);
//                        RedisUtil.putValue(id,resultVO,30l, TimeUnit.MINUTES);
//
//                        if(!AssertUtil.isEmpty(importVo.getError())){
//                            errorList.add(importVo);
//                            continue;
//                        }
//
//                        // 校验导入数据
//                        String msg = taskSettingService.validImportTaskSaleData(importVo, taskSettingSalesMap);
//                        if (AssertUtil.isEmpty(msg)) {
//                            ImportTaskSalesVO vo = new ImportTaskSalesVO();
//                            vo.setWxUserId(importVo.getWxUserId());
//                            insertList.add(vo);
//                        } else {
//                            importVo.setError(msg);
//                            errorList.add(importVo);
//                            continue;
//                        }
//                    }
//                    taskSettingService.importSales(insertList, taskSettingId, creator, orgId);
//                }
//            } catch (Exception e) {
//                resultVO.setFinish(true);
//                resultVO.setTips("导入数据采集区域失败");
//                RedisUtil.putValue(id,resultVO,30l, TimeUnit.MINUTES);
//            } finally {
//                file.delete();
//                resultVO.setFinish(true);
//                resultVO.setTips("导入完成");
//                RedisUtil.putValue(id,resultVO,30l, TimeUnit.MINUTES);
//                log.info("------------完成导入区域数据--------------");
//            }
//
